@echo off
rem
rem Copyright 2001, 2016, Oracle and/or its affiliates. All rights reserved.
...
rem U.S. GOVERNMENT END USERS: Oracle programs, including any operatingsystem,
rem integrated software, any programs installed on the hardware,
...
rem IFCR exportContent
rem Used to export Workbench content to disk in ECR format as JSON files.  Used to extract all templates

call %~dp0runcommand.bat IFCR exportContent templates %~dp0..\config\import\templates true