...
echo Exporting editors..

call %~dp0runcommand.bat IFCR exportContent editors %~dp0..\config\import\editors true

echo Exporting configuration..

call %~dp0runcommand.bat IFCR exportContent configuration/tools/xmgr %~dp0..\config\import\configuration\tools\xmgr true