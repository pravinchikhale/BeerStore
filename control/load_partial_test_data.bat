...
call %~dp0set_partial_data_ready_flag.bat adds.txt.gz
call %~dp0set_partial_data_ready_flag.bat deletes.txt.gz
call %~dp0set_partial_data_ready_flag.bat updates.txt.gz
