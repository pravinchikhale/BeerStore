@echo off
rem
rem Copyright 2011, 2013, Oracle and/or its affiliates. All rights reserved.
...
IF "%1"=="" (
  echo ERROR: one argument required, specifying partial extract filename.
  exit /b 1
)

echo Setting flag 'partial_extract::%1' in the EAC.
call %~dp0runcommand.bat --skip-definition LockManager setFlag "partial_extract::%1"
exit /b 0